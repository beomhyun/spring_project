...
<div id="mainPage">
   ...
   <c:forEach items="${foodinfos}" var="foodinfo" varStatus="vs">
                           <article class="style1">
                              ...
                              <a href='<%=request.getContextPath()%>/FoodControllerServlet.do?action=detail&barcode=${foodinfo.food_code}'>
                                 <div class="content">
...
<%--    <c:forEach items="${foodinfos}" var="foodinfo" varStatus="vs"> --%>
<%--       <div data-layout='_r' class='MOD_IMPACTSTRIP3'   divcode='${foodinfo.food_code}' onclick="detail('${foodinfo.food_code}')"> --%>
<%--          <div data-layout='al16 de8' class='MOD_IMPACTSTRIP3_Img' style='background-image:url("${foodinfo.food_img}"); background-size: 35%';> --%>
<!--          </div> -->
